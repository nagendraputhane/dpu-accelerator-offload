...
| **_marvell-firmware-cpt_**      | ![GitHub Release](https://img.shields.io/github/v/release/MarvellEmbeddedProcessors/marvell-firmware?sort=date&filter=cpt*)                     | [![build-cn10k](https://github.com/MarvellEmbeddedProcessors/marvell-firmware/actions/workflows/build-cpt-ml.yml/badge.svg)](https://github.com/MarvellEmbeddedProcessors/marvell-firmware/actions/workflows/build-cpt-ml.yml)                   |
| **_marvell-firmware-ml_**      | ![GitHub Release](https://img.shields.io/github/v/release/MarvellEmbeddedProcessors/marvell-firmware?sort=date&filter=ml*)                     | [![build-cn10k](https://github.com/MarvellEmbeddedProcessors/marvell-firmware/actions/workflows/build-cpt-ml.yml/badge.svg)](https://github.com/MarvellEmbeddedProcessors/marvell-firmware/actions/workflows/build-cpt-ml.yml)                   |
...
|  | Inferencing application - DDoS detection | ![](https://img.shields.io/static/v1?label=&message=Ready&color=green) | [Link](https://marvellembeddedprocessors.github.io/dao/guides/applications/machine-learning.html#lucid) |
